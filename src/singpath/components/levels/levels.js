 ...
 *
 */
singpath.factory('levelListCtrlInitialData', [
  '$q',
  '$route',
  'spfAuth',
  'spfAuthData',
 ...
 *
 */
singpath.controller('LevelListCtrl', [
  'initialData',
  'urlFor',
  'spfNavBarService',
 ...
 */
singpath.factory('newLevelCtrlInitialData', [
  '$q',
  '$route',
  'spfAuth',
  'spfAuthData',
 ...
 *
 */
singpath.controller('NewLevelCtrl', [
  '$q',
  '$location',
  'initialData',
  'urlFor',
