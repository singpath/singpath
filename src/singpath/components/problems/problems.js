 ...
 *
 */
singpath.factory('baseProblemListResolver', [
  '$route',
  'spfAuth',
  'spfAuthData',
  'spfDataStore',
 ...
 *
 */
singpath.factory('problemListCtrlInitialData', [
  '$q',
 ...
 *
 */
singpath.controller('ProblemListCtrl', [
  'initialData',
  'urlFor',
  'spfNavBarService',
 ...
 *
 */
singpath.factory('editProblemsCtrlInitialData', [
  '$q',
  'baseProblemListResolver',
  'spfDataStore',
 ...
 *
 */
singpath.controller('EditProblemsCtrl', [
  '$log',
  '$q',
  'initialData',
  'urlFor',
 ...
 *
 */
singpath.factory('playProblemCtrlInitialData', [
  '$log',
  '$q',
  '$location',
  '$route',
 ...
 *
 */
singpath.controller('PlayProblemCtrl', [
  '$scope',
  '$q',
  '$log',
  '$location',
